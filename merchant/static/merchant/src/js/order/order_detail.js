$(document).ready(function () {
    ...
    $.ajax({
        url: 'http://54.213.242.175:8000/merchant/order/' + id_order,
        method: 'GET',
    ...
    var table = $('#dataTables-example').dataTable({
        ...
        "ajax": {
            "processing": true,
            "url": "http://54.213.242.175:8000/merchant/orders_detail/" + id_order,
            "dataSrc": ""
        },
...
function rating_customer(id_order){
    ...
    $.ajax({
        url: 'http://54.213.242.175:8000/merchant/rating_customer',
        method: 'POST',
...
function change_state(order_id, state){
    ...
    $("#loader").css("display","block");
    $.ajax({
        url: 'http://54.213.242.175:8000/merchant/change_state/' + order_id + '/' + state,
        method: 'GET',
        success: function(response){
            if (response == 1){
