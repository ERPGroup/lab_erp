$(document).ready(function () {
    ...
    $.ajax({
        url: 'https://laberp.pythonanywhere.com/merchant/order/' + id_order,
        method: 'GET',
    ...
    var table = $('#dataTables-example').dataTable({
        ...
        "ajax": {
            "processing": true,
            "url": "https://laberp.pythonanywhere.com/merchant/orders_detail/" + id_order,
            "dataSrc": ""
        },
...
function rating_customer(id_order){
    ...
    $.ajax({
        url: 'https://laberp.pythonanywhere.com/merchant/rating_customer',
        method: 'POST',
...
function change_state(order_id, state){
    ...
    $("#loader").css("display","block");
    $.ajax({
        url: 'https://laberp.pythonanywhere.com/merchant/change_state/' + order_id + '/' + state,
        method: 'GET',
        success: function(response){
            if (response == 1){
