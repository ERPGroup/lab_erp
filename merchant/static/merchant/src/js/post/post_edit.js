$(document).ready(function(){
    ...
    $.ajax({
        url: 'http://13.67.105.209:8000/merchant/post/' + id_post,
        method: 'GET',
        ...
        success: function(response){
            ...
            //Load Product
            $.ajax({
                url: 'http://13.67.105.209:8000/merchant/product/' + post.product_id ,
                method: 'GET',
                contentType: 'application/json',
                success: function(response){
...
function showProduct(id_product){
    $.ajax({
        url: 'http://13.67.105.209:8000/merchant/product/'+ id_product + '?posted=true',
        method: 'GET',
        contentType: 'application/json',
        success: function(response){
            item = ''
