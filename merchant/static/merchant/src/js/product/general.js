...
function delete_image(id_image){
  $.ajax({
    url: 'http://54.213.242.175:8000/merchant/delete_image/' + id_image,
    method: 'DELETE',
    success: function(response){
      $('#upload_photo').val(''); 
      alert(response);
...
$(document).ready(function(){
  $.ajax({
    url: 'http://54.213.242.175:8000/merchant/categorys',
    method: 'GET',
    contentType: 'application/json',
    success: function(response){
...
function load_category_autocomplete(keyword){
  $("#list-category").empty()
  $.ajax({
    url: 'http://54.213.242.175:8000/merchant/categorys?keyword=' + keyword,
    method: 'GET',
    contentType: 'application/json',
    success: function(response){
      for (var item = 0; item < response.length; item++){
