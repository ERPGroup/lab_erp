$(document).ready(function(){
    // Load data 
    $.ajax({
        url: 'http://13.67.105.209:8000/customer/user',
        method: 'GET',
    ...
    $('#password').click(function(){
        ...
        $.ajax({
            url: 'http://13.67.105.209:8000/customer/password',
            method: 'POST',
            ...
            success: function(response){
                console.log(response);
                if(response == 1){
                    setTimeout("location.href = 'http://13.67.105.209:8000/customer/profile';",0);
    ...
    $('#info').click(function(){
        ...
        console.log(data)
        $.ajax({
            url: 'http://13.67.105.209:8000/customer/info',
            method: 'POST',
            contentType: 'application/x-www-form-urlencoded',
            data: data,
            success: function(response){
