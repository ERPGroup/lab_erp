$(document).ready(function () {
    ...
    url = 'https://laberp.pythonanywhere.com/product_collection/' + id_category + '?';
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            for (var i = 0; i < response.data.length; i++) {
                ...
                url_paginator = 'https://laberp.pythonanywhere.com/collections/' + id_category + '?';
                if (GetURLParameter('newest') != undefined) {
...
function Newest_down() {
    ...
    var check_url = $(location).attr('pathname').split('/');
    var id_category = check_url[check_url.length - 1]
    url = 'https://laberp.pythonanywhere.com/collections/' + id_category;
    if (GetURLParameter('page') == undefined) {
        url += '?newest=true&'
    } else {
