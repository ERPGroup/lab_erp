$(document).ready(function(){
    ...
    $.ajax({
        url: 'http://13.67.105.209:8000/get_product_shop/' + id_shop,
        method: 'GET',
        ...
        success: function(response){
            ...
            for( var i = 0 ; i < response.data.length; i++){
                ...
                if (response.has_previous == true)
                    paginator += '<li><a href="http://13.67.105.209:8000/shop/'+ id_shop +'?page='+ (response.page - 1) +'">&laquo;</a></li>'

                paginator += '<li><a>'+ response.page +'</a></li>'
                if (response.has_next == true)
                    paginator += '<li><a href="http://13.67.105.209:8000/shop/'+ id_shop +'?page='+ (response.page + 1) +'">&raquo;</a></li>'
...
function rating_merchant(){
    ...
    $.ajax({
        url: 'http://13.67.105.209:8000/rating_merchant_shop/' + id_shop,
        method: 'POST',
