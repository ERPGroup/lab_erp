...
function add_product(id_product){
    $.ajax({
        url: 'https://laberp.pythonanywhere.com/add/' + id_product,
        method: 'GET',
...
function sub_product(id_product){
    $.ajax({
        url: 'https://laberp.pythonanywhere.com/sub/' + id_product,
        method: 'GET',
        success: function(response){
            if(response == 1){
...
function set_qty(id_product, qty){
    $.ajax({
        url: 'https://laberp.pythonanywhere.com/set_qty/' + id_product + '/' + qty,
        method: 'GET',
        success: function(response){
            if(response == 1){
...
function remove(id_product){
    $.ajax({
        url: 'https://laberp.pythonanywhere.com/remove/' + id_product,
        method: 'GET',
        success: function(response){
            alert(response);
            window.location.replace('/cart');
