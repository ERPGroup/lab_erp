$(document).ready(function(){
    ...
    $.ajax({
        ...
        success: function(response){
            ...
            $.ajax({
                url: 'https://laberp.pythonanywhere.com/get_data_hot_buy',
                method: 'GET',
                success: function(response){
                    var html = ''
            ...
            // $.ajax({
            //     url: 'https://laberp.pythonanywhere.com/get_data_related/' + response.product.categories[0].id,
            //     method: 'GET',
            //     success: function(response){
            //         var html = ''
            //         posts = response.datas
...
function rating_merchant(){
    ...
    $.ajax({
        url: 'https://laberp.pythonanywhere.com/rating_merchant/' + id_post,
        method: 'POST',
