$(document).ready(function(){
    ...
    $.ajax({
        ...
        success: function(response){
            ...
            $.ajax({
                url: 'http://13.67.105.209:8000/get_data_hot_buy',
                method: 'GET',
                success: function(response){
                    var html = ''
                    ...
                    for(var item=0; item < response.datas.length; item++){
                        ...
                        html += '<button class="btn_buy" onclick="location.href=\'http://13.67.105.209:8000/post/'+ posts[item].id +'\';">Xem thêm</button>'
                        html += '</div>'
                        html += '</div>'
                    }
            ...
            // $.ajax({
            //     url: 'http://13.67.105.209:8000/get_data_related/' + response.product.categories[0].id,
            //     method: 'GET',
            //     success: function(response){
            //         var html = ''
            //         posts = response.datas
...
function rating_merchant(){
    ...
    $.ajax({
        url: 'http://13.67.105.209:8000/rating_merchant/' + id_post,
        method: 'POST',
