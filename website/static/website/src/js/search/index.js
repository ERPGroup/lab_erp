$(document).ready(function(){
    ...
    url = 'http://13.67.105.209:8000/f_search?r=' + GetURLParameter('r') + '&';
    ...
    $.ajax({
        ...
        success: function(response){
            ...
            for( var i = 0 ; i < response.data.length; i++){
                ...
                url_paginator = 'http://13.67.105.209:8000/search?' + GetURLParameter('r') + '&';;
                if(GetURLParameter('newest') != undefined){
...
function Newest_down() {
    ...
    url = 'http://13.67.105.209:8000/search?r=' + GetURLParameter('r') + '&';
    if (GetURLParameter('page') == undefined){
        url += 'newest=true&'
    }
    else{
