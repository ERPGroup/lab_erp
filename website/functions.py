...
def payment(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            raise
        cart.clear()
        send_email_notifile(customer.email, 'Sản phẩm đặt mua thành công', 'Bạn có thể xem thông tin đơn hàng tại <a href="http://54.213.242.175:8000/customer/bill_detail/'+ str(order.id) +'"> đây</a>')
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 500px;" class="wrapper">
                    <tr>
                        <td align="center" valign="top" style="padding: 15px 0;" class="logo">
                            <a href="http://54.213.242.175:8000" target="_blank">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="max-width: 500px;" class="responsive-table">
                    <tr>
                        <td align="center" style="font-size: 12px; line-height: 18px; font-family: Helvetica, Arial, sans-serif; color:#666666;">
                            ...
                            <br>
                            <a href="http://54.213.242.175:8000" target="_blank" style="color: #666666; text-decoration: none;">Trang chủ</a>
                        </td>
                    </tr>
                </table>
            </td>
